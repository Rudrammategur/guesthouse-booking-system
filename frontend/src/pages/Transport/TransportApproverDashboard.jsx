...
function TransportApproverDashboard() {
    ...
    const loadDashboard = useCallback(async () => {
        ...
        try {
            ...
            const [
                ...
                api.get(
                    "/api/transport-approver/applications"
                ),

                api.get(
                    "/api/transport-approver/dashboard-counts"
                )
            ...
            console.log(
                "Transport Approver Applications Response:",
                applicationResponse.data
            );

            console.log(
                "Transport Approver Dashboard Counts Response:",
                countResponse.data
            );
    ...
    return (
        ...
        <ERPPage>
            ...
            <PageHeader
                ...
                description="Review and approve verified transport booking applications."
                ...
                <ERPTable
                    ...
                    actions={(row) => (
                        ...
                        <Button
                            onClick={() =>
                                navigate(
                                    `/transport-approver/application/${row.TransportBookingID}`
                                )
                            }
                        >
                            View
...
export default TransportApproverDashboard;
